...
#ifdef HAVE_DILITHIUM
    /* By default enable sign, verify, key export and import */
    #ifndef NO_DILITHIUM_SIGN
        #undef HAVE_DILITHIUM_SIGN
        #define HAVE_DILITHIUM_SIGN
    #endif
    #ifndef NO_DILITHIUM_VERIFY
        #undef HAVE_DILITHIUM_VERIFY
        #define HAVE_DILITHIUM_VERIFY
    #endif
    #ifndef NO_DILITHIUM_KEY_EXPORT
        #undef HAVE_DILITHIUM_KEY_EXPORT
        #define HAVE_DILITHIUM_KEY_EXPORT
    #endif
    #ifndef NO_DILITHIUM_KEY_IMPORT
        #undef HAVE_DILITHIUM_KEY_IMPORT
        #define HAVE_DILITHIUM_KEY_IMPORT
    #endif
...
#ifdef HAVE_FALCON
    /* By default enable sign, verify, key export and import */
    #ifndef NO_FALCON_SIGN
        #undef HAVE_FALCON_SIGN
        #define HAVE_FALCON_SIGN
    #endif
    #ifndef NO_FALCON_VERIFY
        #undef HAVE_FALCON_VERIFY
        #define HAVE_FALCON_VERIFY
    #endif
    #ifndef NO_FALCON_KEY_EXPORT
        #undef HAVE_FALCON_KEY_EXPORT
        #define HAVE_FALCON_KEY_EXPORT
    #endif
    #ifndef NO_FALCON_KEY_IMPORT
        #undef HAVE_FALCON_KEY_IMPORT
        #define HAVE_FALCON_KEY_IMPORT
    #endif
#endif /* HAVE_FALCON */
...
#ifdef HAVE_SPHINCS
    /* By default enable sign, verify, key export and import */
    #ifndef NO_SPHINCS_SIGN
        #undef HAVE_SPHINCS_SIGN
        #define HAVE_SPHINCS_SIGN
    #endif
    #ifndef NO_SPHINCS_VERIFY
        #undef HAVE_SPHINCS_VERIFY
        #define HAVE_SPHINCS_VERIFY
    #endif
    #ifndef NO_SPHINCS_KEY_EXPORT
        #undef HAVE_SPHINCS_KEY_EXPORT
        #define HAVE_SPHINCS_KEY_EXPORT
    #endif
    #ifndef NO_SPHINCS_KEY_IMPORT
        #undef HAVE_SPHINCS_KEY_IMPORT
        #define HAVE_SPHINCS_KEY_IMPORT
    #endif
#endif /* HAVE_SPHINCS */
...
/* XMSS Configs */
    ...
    /* By default enable sign, verify, key export and import */
    #ifndef NO_XMSS_SIGN
        #undef HAVE_XMSS_SIGN
        #define HAVE_XMSS_SIGN
    #endif
    #ifndef NO_XMSS_VERIFY
        #undef HAVE_XMSS_VERIFY
        #define HAVE_XMSS_VERIFY
    #endif
    #ifndef NO_XMSS_KEY_EXPORT
        #undef HAVE_XMSS_KEY_EXPORT
        #define HAVE_XMSS_KEY_EXPORT
    #endif
    #ifndef NO_XMSS_KEY_IMPORT
        #undef HAVE_XMSS_KEY_IMPORT
        #define HAVE_XMSS_KEY_IMPORT
    #endif
#endif /* HAVE_XMSS */

/* Kyber Configs */
#ifdef HAVE_KYBER
    #ifndef NO_KYBER_ENCRYPT
        #undef HAVE_KYBER_ENCRYPT
        #define HAVE_KYBER_ENCRYPT
    #endif
#endif /* HAVE_KYBER */
