...
enum CertType {
    ...
    ECC_PRIVATEKEY_TYPE,
    DSA_PRIVATEKEY_TYPE,
    DILITHIUM_PRIVATEKEY_TYPE,
    FALCON_PRIVATEKEY_TYPE,
    SPHINCS_PRIVATEKEY_TYPE,
    XMSS_PRIVATEKEY_TYPE,
    CERTREQ_TYPE,
    DSA_TYPE,
    ECC_TYPE,
    RSA_TYPE,
    ...
    RSA_PUBLICKEY_TYPE,
    ECC_PUBLICKEY_TYPE,
    DILITHIUM_PUBLICKEY_TYPE,
    FALCON_PUBLICKEY_TYPE,
    SPHINCS_PUBLICKEY_TYPE,
    XMSS_PUBLICKEY_TYPE,
    TRUSTED_PEER_TYPE,
...
enum Ctc_SigType {
    ...
    CTC_ED25519      = 256,
    CTC_ED448        = 257,
    CTC_SHA256wDilithium = 527,  /* OID not for Dilithium unknown yet */
    CTC_SHA384wDilithium = 528,  /* OID not for Dilithium unknown yet */
    CTC_SHA512wDilithium = 529,  /* OID not for Dilithium unknown yet */
    CTC_SHA256wFalcon    = 530,  /* OID not for Falcon unknown yet */
    CTC_SHA384wFalcon    = 531,  /* OID not for Falcon unknown yet */
    CTC_SHA512wFalcon    = 532,  /* OID not for Falcon unknown yet */
    CTC_SHA256wSphincs   = 533,  /* OID not for Sphincs unknown yet */
    CTC_SHA384wSphincs   = 534,  /* OID not for Sphincs unknown yet */
    CTC_SHA512wSphincs   = 535,  /* OID not for Sphincs unknown yet */
    CTC_SHA256wXMSS      = 536,  /* OID not for XMSS unknown yet */
    CTC_SHA384wXMSS      = 537,  /* OID not for XMSS unknown yet */
    CTC_SHA512wXMSS      = 538   /* OID not for XMSS unknown yet */
};
...
WOLFSSL_API int wc_SetSubjectKeyIdFromDilithiumPublicKey(Cert *cert,
                                             DilithiumKey *dilithiumKey);
#endif
#ifdef HAVE_FALCON
WOLFSSL_API int wc_SetSubjectKeyIdFromFalconPublicKey(Cert *cert,
                                             FalconKey *falconKey);
#endif
#ifdef HAVE_SPHINCS
WOLFSSL_API int wc_SetSubjectKeyIdFromSphincsPublicKey(Cert *cert,
                                             SphincsKey *sphincsKey);
#endif
#ifdef HAVE_XMSS
WOLFSSL_API int wc_SetSubjectKeyIdFromXmssPublicKey(Cert *cert,
                                             XmssKey *xmssKey);
#endif
...
WOLFSSL_API int wc_SetExtKeyUsageOID(Cert *cert, const char *oid, word32 sz,
    ...
    #ifdef HAVE_DILITHIUM
        WOLFSSL_API int wc_MakeDilithiumCert(Cert* cert, byte* derBuffer, word32 derSz,
                                             DilithiumKey* dilithiumKey, WC_RNG* rng);
    #endif

    #ifdef HAVE_FALCON
        WOLFSSL_API int wc_MakeFalconCert(Cert* cert, byte* derBuffer, word32 derSz,
                                             FalconKey* falconKey, WC_RNG* rng);
    #endif

    #ifdef HAVE_SPHINCS
        WOLFSSL_API int wc_MakeSphincsCert(Cert* cert, byte* derBuffer, word32 derSz,
                                             SphincsKey* sphincsKey, WC_RNG* rng);
    #endif

    #ifdef HAVE_XMSS
        WOLFSSL_API int wc_MakeXmssCert(Cert* cert, byte* derBuffer, word32 derSz,
...
#ifdef HAVE_DILITHIUM
    /* private key helpers */
    WOLFSSL_API int wc_DilithiumPrivateKeyDecode(const byte*, word32*,
                                             DilithiumKey*, word32);
    WOLFSSL_API int wc_DilithiumKeyToDer(DilithiumKey* key, byte* output,
                                     word32 inLen);

    /* public key helper */
    WOLFSSL_API int wc_DilithiumPublicKeyDecode(const byte*, word32*,
                                            DilithiumKey*, word32);
    #if (defined(WOLFSSL_CERT_GEN) || defined(WOLFSSL_KEY_GEN))
        WOLFSSL_API int wc_DilithiumPublicKeyToDer(DilithiumKey*, byte* output,
                                               word32 inLen, int with_AlgCurve);
    #endif
#endif
...
#ifdef HAVE_FALCON
    /* private key helpers */
    WOLFSSL_API int wc_FalconPrivateKeyDecode(const byte*, word32*,
                                             FalconKey*, word32);
    WOLFSSL_API int wc_FalconKeyToDer(FalconKey* key, byte* output,
                                     word32 inLen);

    /* public key helper */
    WOLFSSL_API int wc_FalconPublicKeyDecode(const byte*, word32*,
                                            FalconKey*, word32);
    #if (defined(WOLFSSL_CERT_GEN) || defined(WOLFSSL_KEY_GEN))
        WOLFSSL_API int wc_FalconPublicKeyToDer(FalconKey*, byte* output,
                                               word32 inLen, int with_AlgCurve);
    #endif
#endif
...
#ifdef HAVE_SPHINCS
    /* private key helpers */
    WOLFSSL_API int wc_SphincsPrivateKeyDecode(const byte*, word32*,
                                               SphincsKey*, word32);
    WOLFSSL_API int wc_SphincsKeyToDer(SphincsKey* key, byte* output,
                                       word32 inLen);

    /* public key helper */
    WOLFSSL_API int wc_SphincsPublicKeyDecode(const byte*, word32*,
                                              SphincsKey*, word32);
    #if (defined(WOLFSSL_CERT_GEN) || defined(WOLFSSL_KEY_GEN))
        WOLFSSL_API int wc_SphincsPublicKeyToDer(SphincsKey*, byte* output,
                                            word32 inLen, int with_AlgCurve);
    #endif
#endif
...
#ifdef HAVE_XMSS
    /* private key helpers */
    WOLFSSL_API int wc_XmssPrivateKeyDecode(const byte*, word32*,
                                            XmssKey*, word32);
    WOLFSSL_API int wc_XmssKeyToDer(XmssKey* key, byte* output,
                                    word32 inLen);

    /* public key helper */
    WOLFSSL_API int wc_XmssPublicKeyDecode(const byte*, word32*,
                                           XmssKey*, word32);
    #if (defined(WOLFSSL_CERT_GEN) || defined(WOLFSSL_KEY_GEN))
        WOLFSSL_API int wc_XmssPublicKeyToDer(XmssKey*, byte* output,
                                            word32 inLen, int with_AlgCurve);
    #endif
#endif
