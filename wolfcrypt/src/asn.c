...
#ifdef HAVE_DILITHIUM
#ifndef NO_SHA256
    static const char sigSha256wDilithiumName[] = "SHA256wDilithium";
#endif
#ifdef WOLFSSL_SHA384
    static const char sigSha384wDilithiumName[] = "SHA384wDilithium";
#endif
#ifdef WOLFSSL_SHA512
    static const char sigSha512wDilithiumName[] = "SHA512wDilithium";
#endif
#endif /* HAVE_DILITHIUM */
#ifdef HAVE_FALCON
#ifndef NO_SHA256
    static const char sigSha256wFalconName[] = "SHA256wFalcon";
#endif
#ifdef WOLFSSL_SHA384
    static const char sigSha384wFalconName[] = "SHA384wFalcon";
#endif
#ifdef WOLFSSL_SHA512
    static const char sigSha512wFalconName[] = "SHA512wFalcon";
#endif
#endif /* HAVE_FALCON */
#ifdef HAVE_SPHINCS
#ifndef NO_SHA256
    static const char sigSha256wSphincsName[] = "SHA256wSphincs";
#endif
#ifdef WOLFSSL_SHA384
    static const char sigSha384wSphincsName[] = "SHA384wSphincs";
#endif
#ifdef WOLFSSL_SHA512
    static const char sigSha512wSphincsName[] = "SHA512wSphincs";
#endif
#endif /* HAVE_SPHINCS */
#ifdef HAVE_XMSS
#ifndef NO_SHA256
    static const char sigSha256wXmssName[] = "SHA256wXMSS";
#endif
#ifdef WOLFSSL_SHA384
    static const char sigSha384wXmssName[] = "SHA384wXMSS";
#endif
#ifdef WOLFSSL_SHA512
    static const char sigSha512wXmssName[] = "SHA512wXMSS";
#endif
#endif /* HAVE_XMSS */
...
const char* GetSigName(int oid) {
    ...
    #ifdef HAVE_DILITHIUM
        #ifndef NO_SHA256
        case CTC_SHA256wDilithium:
            return sigSha256wDilithiumName;
        #endif
        #ifdef WOLFSSL_SHA384
        case CTC_SHA384wDilithium:
            return sigSha384wDilithiumName;
        #endif
        #ifdef WOLFSSL_SHA512
        case CTC_SHA512wDilithium:
            return sigSha512wDilithiumName;
        #endif
    #endif /* HAVE_DILITHIUM */
    #ifdef HAVE_FALCON
        #ifndef NO_SHA256
        case CTC_SHA256wFalcon:
            return sigSha256wFalconName;
        #endif
        #ifdef WOLFSSL_SHA384
        case CTC_SHA384wFalcon:
            return sigSha384wFalconName;
        #endif
        #ifdef WOLFSSL_SHA512
        case CTC_SHA512wFalcon:
            return sigSha512wFalconName;
        #endif
    #endif /* HAVE_FALCON */
    #ifdef HAVE_SPHINCS
        #ifndef NO_SHA256
        case CTC_SHA256wSphincs:
            return sigSha256wSphincsName;
        #endif
        #ifdef WOLFSSL_SHA384
        case CTC_SHA384wSphincs:
            return sigSha384wSphincsName;
        #endif
        #ifdef WOLFSSL_SHA512
        case CTC_SHA512wSphincs:
            return sigSha512wSphincsName;
        #endif
    #endif /* HAVE_SPHINCS */
    #ifdef HAVE_XMSS
        #ifndef NO_SHA256
        case CTC_SHA256wXMSS:
            return sigSha256wXmssName;
        #endif
        #ifdef WOLFSSL_SHA384
        case CTC_SHA384wXMSS:
            return sigSha384wXmssName;
        #endif
        #ifdef WOLFSSL_SHA512
        case CTC_SHA512wXMSS:
            return sigSha512wXmssName;
        #endif
    #endif /* HAVE_XMSS */
        default:
...
#if !defined(NO_DSA) || defined(HAVE_ECC) || defined(HAVE_DILITHIUM) || defined(HAVE_FALCON) || \
    defined(HAVE_SPHINCS) || defined(HAVE_XMSS) || \
    !defined(NO_CERTS) || \
   (!defined(NO_RSA) && \
...
/* RSA (with CertGen or KeyGen) OR ECC OR ED25519 OR ED448 OR Dilithium OR Falcon OR Sphincs OR XMSS
 * (with CertGen or KeyGen) */
#if (!defined(NO_RSA) && !defined(HAVE_USER_RSA) && \
        (defined(WOLFSSL_CERT_GEN) || defined(WOLFSSL_KEY_GEN) || defined(OPENSSL_EXTRA))) || \
    (defined(HAVE_ECC) && defined(HAVE_ECC_KEY_EXPORT)) || \
    ((defined(HAVE_ED25519) || defined(HAVE_ED448) || defined(HAVE_DILITHIUM) || defined(HAVE_FALCON) || \
    defined(HAVE_SPHINCS) || defined(HAVE_XMSS)) && \
        (defined(WOLFSSL_CERT_GEN) || defined(WOLFSSL_KEY_GEN) || defined(OPENSSL_EXTRA))) || \
...
#endif /* !NO_RSA || HAVE_ECC || HAVE_ED25519 || HAVE_ED448 || HAVE_DILITHIUM ||
          HAVE_FALCON  || HAVE_SPHINCS || HAVE_XMSS */
...
#endif /* HAVE_ED448 */
#ifdef HAVE_DILITHIUM       /* OID for Dilithium is unknown yet */
    #ifndef NO_SHA256
    static const byte sigSha256wDilithiumOid[] = {42, 134, 72, 206, 61, 4, 3, 5};
    #endif
    #ifdef WOLFSSL_SHA384
    static const byte sigSha384wDilithiumOid[] = {42, 134, 72, 206, 61, 4, 3, 6};
    #endif
    #ifdef WOLFSSL_SHA512
    static const byte sigSha512wDilithiumOid[] = {42, 134, 72, 206, 61, 4, 3, 7};
    #endif
#endif /* HAVE_DILITHIUM */
#ifdef HAVE_FALCON         /* OID for Falcon is unknown yet */
    #ifndef NO_SHA256
    static const byte sigSha256wFalconOid[] = {42, 134, 72, 206, 61, 4, 3, 8};
    #endif
    #ifdef WOLFSSL_SHA384
    static const byte sigSha384wFalconOid[] = {42, 134, 72, 206, 61, 4, 3, 9};
    #endif
    #ifdef WOLFSSL_SHA512
    static const byte sigSha512wFalconOid[] = {42, 134, 72, 206, 61, 4, 3, 10};
    #endif
#endif /* HAVE_FALCON */
#ifdef HAVE_SPHINCS        /* OID for Sphincs is unknown yet */
    #ifndef NO_SHA256
    static const byte sigSha256wSphincsOid[] = {42, 134, 72, 206, 61, 4, 3, 11};
    #endif
    #ifdef WOLFSSL_SHA384
    static const byte sigSha384wSphincsOid[] = {42, 134, 72, 206, 61, 4, 3, 12};
    #endif
    #ifdef WOLFSSL_SHA512
    static const byte sigSha512wSphincsOid[] = {42, 134, 72, 206, 61, 4, 3, 13};
    #endif
#endif /* HAVE_SPHINCS */
#ifdef HAVE_XMSS           /* OID for XMSS is unknown yet */
    #ifndef NO_SHA256
    static const byte sigSha256wXmssOid[] = {42, 134, 72, 206, 61, 4, 3, 14};
    #endif
    #ifdef WOLFSSL_SHA384
    static const byte sigSha384wXmssOid[] = {42, 134, 72, 206, 61, 4, 3, 15};
    #endif
    #ifdef WOLFSSL_SHA512
    static const byte sigSha512wXmssOid[] = {42, 134, 72, 206, 61, 4, 3, 16};
    #endif
#endif /* HAVE_XMSS */
...
#endif /* HAVE_ED448 */
#ifdef HAVE_DILITHIUM
    static const byte keyDilithiumOid[] = {43, 101, 114}; /* OID for Dilithium is unknown yet */
#endif /* HAVE_DILITHIUM */
#ifdef HAVE_FALCON
    static const byte keyFalconOid[] = {43, 101, 115};    /* OID for Falcon is unknown yet */
#endif /* HAVE_FALCON */
#ifdef HAVE_SPHINCS
    static const byte keySphincsOid[] = {43, 101, 116};   /* OID for Sphincs is unknown yet */
#endif /* HAVE_SPHINCS */
#ifdef HAVE_XMSS
    static const byte keyXmssOid[] = {43, 101, 117};      /* OID for XMSS is unknown yet */
#endif /* HAVE_XMSS */
#ifndef NO_DH
    ...
    switch (type) {
        ...
        case oidSigType:
            switch (id) {
                ...
                #ifndef NO_SHA256
                case CTC_SHA256wDilithium:
                    oid = sigSha256wDilithiumOid;
                    *oidSz = sizeof(sigSha256wDilithiumOid);
                    break;
                #endif
                #ifdef WOLFSSL_SHA384
                case CTC_SHA384wDilithium:
                    oid = sigSha384wDilithiumOid;
                    *oidSz = sizeof(sigSha384wDilithiumOid);
                    break;
                #endif
                #ifdef WOLFSSL_SHA512
                case CTC_SHA512wDilithium:
                    oid = sigSha512wDilithiumOid;
                    *oidSz = sizeof(sigSha512wDilithiumOid);
                    break;
                #endif
                #endif /* HAVE_DILITHIUM */
                #ifdef HAVE_FALCON
                #ifndef NO_SHA256
                case CTC_SHA256wFalcon:
                    oid = sigSha256wFalconOid;
                    *oidSz = sizeof(sigSha256wFalconOid);
                    break;
                #endif
                #ifdef WOLFSSL_SHA384
                case CTC_SHA384wFalcon:
                    oid = sigSha384wFalconOid;
                    *oidSz = sizeof(sigSha384wFalconOid);
                    break;
                #endif
                #ifdef WOLFSSL_SHA512
                case CTC_SHA512wFalcon:
                    oid = sigSha512wFalconOid;
                    *oidSz = sizeof(sigSha512wFalconOid);
                    break;
                #endif
                #endif /* HAVE_FALCON */
                #ifdef HAVE_SPHINCS
                #ifndef NO_SHA256
                case CTC_SHA256wSphincs:
                    oid = sigSha256wSphincsOid;
                    *oidSz = sizeof(sigSha256wSphincsOid);
                    break;
                #endif
                #ifdef WOLFSSL_SHA384
                case CTC_SHA384wSphincs:
                    oid = sigSha384wSphincsOid;
                    *oidSz = sizeof(sigSha384wSphincsOid);
                    break;
                #endif
                #ifdef WOLFSSL_SHA512
                case CTC_SHA512wSphincs:
                    oid = sigSha512wSphincsOid;
                    *oidSz = sizeof(sigSha512wSphincsOid);
                    break;
                #endif
                #endif /* HAVE_SPHINCS */
                #ifdef HAVE_XMSS
                #ifndef NO_SHA256
                case CTC_SHA256wXMSS:
                    oid = sigSha256wXmssOid;
                    *oidSz = sizeof(sigSha256wXmssOid);
                    break;
                #endif
                #ifdef WOLFSSL_SHA384
                case CTC_SHA384wXMSS:
                    oid = sigSha384wXmssOid;
                    *oidSz = sizeof(sigSha384wXmssOid);
                    break;
                #endif
                #ifdef WOLFSSL_SHA512
                case CTC_SHA512wXMSS:
                    oid = sigSha512wXmssOid;
                    *oidSz = sizeof(sigSha512wXmssOid);
                    break;
                #endif
                #endif /* HAVE_XMSS */
                default:
        ...
        case oidKeyType:
            switch (id) {
                ...
                case Dilithiumk:
                    oid = keyDilithiumOid;
                    *oidSz = sizeof(keyDilithiumOid);
                    break;
                #endif /* HAVE_DILITHIUM */
                #ifdef HAVE_FALCON
                case Falconk:
                    oid = keyFalconOid;
                    *oidSz = sizeof(keyFalconOid);
                    break;
                #endif /* HAVE_FALCON */
                #ifdef HAVE_SPHINCS
                case Sphincsk:
                    oid = keySphincsOid;
                    *oidSz = sizeof(keySphincsOid);
                    break;
                #endif /* HAVE_SPHINCS */
                #ifdef HAVE_XMSS
                case XMSSk:
                       ...
                       const byte* pubKey, word32 pubKeySz, enum Key_Sum ks)
{
    ...
    #if defined(HAVE_DILITHIUM) && !defined(NO_ASN_CRYPT)
    if (ks == Dilithiumk) {
        DilithiumKey* key_pair = NULL;
        word32     keyIdx = 0;

        key_pair = (DilithiumKey*)XMALLOC(sizeof(DilithiumKey), NULL,
                                                            DYNAMIC_TYPE_DILITHIUM);
        if (key_pair == NULL)
            return MEMORY_E;

        if ((ret = wc_InitDilithiumKey(key_pair)) < 0) {
            XFREE(key_pair, NULL, DYNAMIC_TYPE_DILITHIUM);
            return ret;
        }
        if ((ret = wc_DilithiumPrivateKeyDecode(privKey, &keyIdx, key_pair,
                privKeySz)) == 0) {
            WOLFSSL_MSG("Checking Dilithium key pair");
            keyIdx = 0;
            if ((ret = wc_ImportDilithiumPublic(pubKey, pubKeySz,
                    key_pair)) == 0) {
                if ((pubKeySz != DILITHIUM_KEY_SIZE) ||
                    (XMEMCMP(key_pair->pk, pubKey, DILITHIUM_KEY_SIZE) != 0))
                    ret = 1;
            }
        }
        wc_FreeDilithiumKey(key_pair);
        XFREE(key_pair, NULL, DYNAMIC_TYPE_DILITHIUM);
    }
    else
    #endif /* HAVE_DILITHIUM && !NO_ASN_CRYPT */

    #if defined(HAVE_FALCON) && !defined(NO_ASN_CRYPT)
    if (ks == Falconk) {
        FalconKey* key_pair = NULL;
        word32     keyIdx = 0;

        key_pair = (FalconKey*)XMALLOC(sizeof(FalconKey), NULL,
                                                            DYNAMIC_TYPE_FALCON);
        if (key_pair == NULL)
            return MEMORY_E;

        if ((ret = wc_InitFalconKey(key_pair)) < 0) {
            XFREE(key_pair, NULL, DYNAMIC_TYPE_FALCON);
            return ret;
        }
        if ((ret = wc_FalconPrivateKeyDecode(privKey, &keyIdx, key_pair,
                privKeySz)) == 0) {
            WOLFSSL_MSG("Checking Falcon key pair");
            keyIdx = 0;
            if ((ret = wc_ImportFalconPublic(pubKey, pubKeySz,
                    key_pair)) == 0) {
                if ((pubKeySz != FALCON_KEY_SIZE) ||
                    (XMEMCMP(key_pair->pk, pubKey, FALCON_KEY_SIZE) != 0))
                    ret = 1;
            }
        }
        wc_FreeFalconKey(key_pair);
        XFREE(key_pair, NULL, DYNAMIC_TYPE_FALCON);
    }
    else
    #endif /* HAVE_FALCON && !NO_ASN_CRYPT */

    #if defined(HAVE_SPHINCS) && !defined(NO_ASN_CRYPT)
    if (ks == Sphincsk) {
        SphincsKey* key_pair = NULL;
        word32     keyIdx = 0;

        key_pair = (SphincsKey*)XMALLOC(sizeof(SphincsKey), NULL,
                                                            DYNAMIC_TYPE_SPHINCS);
        if (key_pair == NULL)
            return MEMORY_E;

        if ((ret = wc_InitSphincsKey(key_pair)) < 0) {
            XFREE(key_pair, NULL, DYNAMIC_TYPE_SPHINCS);
            return ret;
        }
        if ((ret = wc_SphincsPrivateKeyDecode(privKey, &keyIdx, key_pair,
                privKeySz)) == 0) {
            WOLFSSL_MSG("Checking Sphincs key pair");
            keyIdx = 0;
            if ((ret = wc_ImportSphincsPublic(pubKey, pubKeySz,
                    key_pair)) == 0) {
                if ((pubKeySz != SPHINCS_KEY_SIZE) ||
                    (XMEMCMP(key_pair->pk, pubKey, SPHINCS_KEY_SIZE) != 0))
                    ret = 1;
            }
        }
        wc_FreeSphincsKey(key_pair);
        XFREE(key_pair, NULL, DYNAMIC_TYPE_SPHINCS);
    }
    else
    #endif /* HAVE_SPHINCS && !NO_ASN_CRYPT */

    #if defined(HAVE_XMSS) && !defined(NO_ASN_CRYPT)
    if (ks == XMSSk) {
        XmssKey* key_pair = NULL;
        word32     keyIdx = 0;

        key_pair = (XmssKey*)XMALLOC(sizeof(XmssKey), NULL,
                                                            DYNAMIC_TYPE_XMSS);
        if (key_pair == NULL)
            return MEMORY_E;

        if ((ret = wc_InitXmssKey(key_pair)) < 0) {
            XFREE(key_pair, NULL, DYNAMIC_TYPE_XMSS);
            return ret;
        }
        if ((ret = wc_XmssPrivateKeyDecode(privKey, &keyIdx, key_pair,
                privKeySz)) == 0) {
            WOLFSSL_MSG("Checking XMSS key pair");
            keyIdx = 0;
            if ((ret = wc_ImportXmssPublic(pubKey, pubKeySz,
                    key_pair)) == 0) {
                if ((pubKeySz != XMSS_KEY_SIZE) ||
                    (XMEMCMP(key_pair->pk, pubKey, XMSS_KEY_SIZE) != 0))
                    ret = 1;
            }
        }
        wc_FreeXmssKey(key_pair);
        XFREE(key_pair, NULL, DYNAMIC_TYPE_XMSS);
    }
    else
    #endif /* HAVE_XMSS && !NO_ASN_CRYPT */
        ...
        int* algoID, void* heap)
{
    ...
    *algoID = 0;
    ...
    if (*algoID != RSAk && *algoID != ECDSAk && *algoID != ED25519k &&
        *algoID != ED448k) {
        DilithiumKey *dilithium = (DilithiumKey *)XMALLOC(sizeof *dilithium, heap, DYNAMIC_TYPE_TMP_BUFFER);
        if (dilithium == NULL)
            return MEMORY_E;

        tmpIdx = 0;
        if (wc_InitDilithiumKey(dilithium) == 0) {
            if (wc_DilithiumPrivateKeyDecode(key, &tmpIdx, dilithium, keySz) == 0) {
                *algoID = Dilithiumk;
            }
            else {
                WOLFSSL_MSG("Not Dilithium DER key");
            }
            wc_FreeDilithiumKey(dilithium);
        }
        else {
            WOLFSSL_MSG("GetKeyOID wc_InitDilithiumKey failed");
        }
...
#if defined(HAVE_FALCON) && !defined(NO_ASN_CRYPT)
    if (*algoID != RSAk && *algoID != ECDSAk && *algoID != ED25519k &&
        *algoID != ED448k && *algoID != Dilithiumk) {
        FalconKey *falcon = (FalconKey *)XMALLOC(sizeof *falcon, heap, DYNAMIC_TYPE_TMP_BUFFER);
        if (falcon == NULL)
            return MEMORY_E;

        tmpIdx = 0;
        if (wc_InitFalconKey(falcon) == 0) {
            if (wc_FalconPrivateKeyDecode(key, &tmpIdx, falcon, keySz) == 0) {
                *algoID = Falconk;
            }
            else {
                WOLFSSL_MSG("Not Falcon DER key");
            }
            wc_FreeFalconKey(falcon);
        }
        else {
            WOLFSSL_MSG("GetKeyOID wc_InitFalconKey failed");
        }
...
#if defined(HAVE_SPHINCS) && !defined(NO_ASN_CRYPT)
    if (*algoID != RSAk && *algoID != ECDSAk && *algoID != ED25519k &&
        *algoID != ED448k && *algoID != Dilithiumk && *algoID != Falconk) {
        SphincsKey *sphincs = (SphincsKey *)XMALLOC(sizeof *sphincs, heap, DYNAMIC_TYPE_TMP_BUFFER);
        if (sphincs == NULL)
            return MEMORY_E;

        tmpIdx = 0;
        if (wc_InitSphincsKey(sphincs) == 0) {
            if (wc_SphincsPrivateKeyDecode(key, &tmpIdx, sphincs, keySz) == 0) {
                *algoID = Sphincsk;
            }
            else {
                WOLFSSL_MSG("Not Sphincs DER key");
            }
            wc_FreeSphincsKey(sphincs);
        }
        else {
            WOLFSSL_MSG("GetKeyOID wc_InitSphincsKey failed");
        }
    ...
    if (*algoID != RSAk && *algoID != ECDSAk && *algoID != ED25519k &&
        *algoID != ED448k && *algoID != Dilithiumk && *algoID != Falconk &&
        *algoID != Sphincsk) {
        XmssKey *xmss = (XmssKey *)XMALLOC(sizeof *xmss, heap, DYNAMIC_TYPE_TMP_BUFFER);
        if (xmss == NULL)
            return MEMORY_E;

        tmpIdx = 0;
        if (wc_InitXmssKey(xmss) == 0) {
            if (wc_XmssPrivateKeyDecode(key, &tmpIdx, xmss, keySz) == 0) {
                *algoID = XMSSk;
            }
            else {
                WOLFSSL_MSG("Not XMSS DER key");
            }
            wc_FreeXmssKey(xmss);
        }
        else {
            WOLFSSL_MSG("GetKeyOID wc_InitXmssKey failed");
        }
        XFREE(xmss, heap, DYNAMIC_TYPE_TMP_BUFFER);
    }
#endif /* HAVE_XMSS && !NO_ASN_CRYPT */

    /* if flag is not set then is neither RSA or ECC or Dilithium or Falcon or Sphincs or
     * XMSS key that could be found */
    if (*algoID == 0) {
...
static int GetKey(DecodedCert* cert)
{
    ...
    int tmpLen;
#endif
#if defined(HAVE_ECC) || defined(HAVE_NTRU) || !defined(NO_DSA) || defined(HAVE_DILITHIUM) || \
    defined(HAVE_FALCON) || defined(HAVE_SPHINCS) || defined(HAVE_XMSS)
...
void FreeSignatureCtx(SignatureCtx* sigCtx)
{
    ...
    if (sigCtx->key.ptr) {
        ...
        #ifdef HAVE_DILITHIUM
            case Dilithiumk:
                wc_FreeDilithiumKey(sigCtx->key.dilithium);
                XFREE(sigCtx->key.dilithium, sigCtx->heap, DYNAMIC_TYPE_DILITHIUM);
                break;
        #endif /* HAVE_DILITHIUM */
        #ifdef HAVE_FALCON
            case Falconk:
                wc_FreeFalconKey(sigCtx->key.falcon);
                XFREE(sigCtx->key.falcon, sigCtx->heap, DYNAMIC_TYPE_FALCON);
                break;
        #endif /* HAVE_FALCON */
        #ifdef HAVE_SPHINCS
            case Sphincsk:
                wc_FreeSphincsKey(sigCtx->key.sphincs);
                XFREE(sigCtx->key.sphincs, sigCtx->heap, DYNAMIC_TYPE_SPHINCS);
                break;
        #endif /* HAVE_SPHINCS */
        #ifdef HAVE_XMSS
            case XMSSk:
                wc_FreeXmssKey(sigCtx->key.xmss);
    ...
    switch (sigCtx->state) {
        ...
        case SIG_STATE_KEY:
        {
            switch (keyOID) {
                ...
                {
                    sigCtx->verify = 0;
                    sigCtx->key.dilithium = (DilithiumKey*)XMALLOC(
                                                sizeof(DilithiumKey), sigCtx->heap,
                                                DYNAMIC_TYPE_DILITHIUM);
                    if (sigCtx->key.dilithium == NULL) {
                        ERROR_OUT(MEMORY_E, exit_cs);
                    }
                    if ((ret = wc_InitDilithiumKey(sigCtx->key.dilithium)) < 0) {
                        goto exit_cs;
                    }
                    if ((ret = wc_ImportDilithiumPublic(key, keySz,
                ...
                {
                    sigCtx->verify = 0;
                    sigCtx->key.falcon = (FalconKey*)XMALLOC(
                                                sizeof(FalconKey), sigCtx->heap,
                                                DYNAMIC_TYPE_FALCON);
                    if (sigCtx->key.falcon == NULL) {
                        ERROR_OUT(MEMORY_E, exit_cs);
                    }
                    if ((ret = wc_InitFalconKey(sigCtx->key.falcon)) < 0) {
                        goto exit_cs;
                    }
                    if ((ret = wc_ImportFalconPublic(key, keySz,
                                                      sigCtx->key.falcon)) < 0) {
                ...
                {
                    sigCtx->verify = 0;
                    sigCtx->key.sphincs = (SphincsKey*)XMALLOC(
                                                sizeof(SphincsKey), sigCtx->heap,
                                                DYNAMIC_TYPE_SPHINCS);
                    if (sigCtx->key.sphincs == NULL) {
                        ERROR_OUT(MEMORY_E, exit_cs);
                    }
                    if ((ret = wc_InitSphincsKey(sigCtx->key.sphincs)) < 0) {
                        goto exit_cs;
                    }
                    if ((ret = wc_ImportSphincsPublic(key, keySz,
                                                      sigCtx->key.sphincs)) < 0) {
                        WOLFSSL_MSG("ASN Key import error Sphincs");
                        goto exit_cs;
                    }
                    break;
                }
                ...
                {
                    sigCtx->verify = 0;
                    sigCtx->key.xmss = (XmssKey*)XMALLOC(
                                                sizeof(XmssKey), sigCtx->heap,
                                                DYNAMIC_TYPE_XMSS);
                    if (sigCtx->key.xmss == NULL) {
                        ERROR_OUT(MEMORY_E, exit_cs);
                    }
                    if ((ret = wc_InitXmssKey(sigCtx->key.xmss)) < 0) {
                        goto exit_cs;
                    }
                    if ((ret = wc_ImportXmssPublic(key, keySz,
                                                      sigCtx->key.xmss)) < 0) {
                        WOLFSSL_MSG("ASN Key import error XMSS");
                        goto exit_cs;
                    }
                    break;
                }
        ...
        case SIG_STATE_DO:
        {
            ...
            case Dilithiumk:
                {
                    ret = wc_DilithiumVerify(sigCtx->digest, (size_t*)&sigCtx->digestSz,
                                             sig, (size_t)sigSz, sigCtx->key.dilithium);
            ...
            case Falconk:
                {
                    ret = wc_FalconVerify(sigCtx->digest, (size_t*)&sigCtx->digestSz,
                                             sig, (size_t)sigSz, sigCtx->key.falcon);
            ...
            case Sphincsk:
                {
                    ret = wc_SphincsVerify(sigCtx->digest, (long long unsigned int*)&sigCtx->digestSz,
                                             sig, (size_t)sigSz, sigCtx->key.sphincs);
            ...
            case XMSSk:
                {
                    ret = wc_XmssVerify(sigCtx->digest, (long long unsigned int*)&sigCtx->digestSz,
                                             sig, (size_t)sigSz, sigCtx->key.xmss);
            ...
            switch (keyOID) {
                ...
                case Falconk:
                {
                    if (sigCtx->verify == 1) {
                        ...
                        WOLFSSL_MSG("Falcon Verify didn't match");
                        ret = ASN_SIG_CONFIRM_E;
                    }
                    break;
                }
                ...
                case Sphincsk:
                {
                    if (sigCtx->verify == 1) {
                        ...
                        WOLFSSL_MSG("Sphincs Verify didn't match");
                        ret = ASN_SIG_CONFIRM_E;
                    }
                    break;
                }
                ...
                case XMSSk:
                {
                    if (sigCtx->verify == 1) {
                        ...
                        WOLFSSL_MSG("XMSS Verify didn't match");
                        ret = ASN_SIG_CONFIRM_E;
                    }
                    break;
                }
...
int AllocDer(DerBuffer** pDer, word32 length, int type, void* heap)
{
    ...
    if (pDer) {
        ...
        switch (type) {
            ...
            case DILITHIUM_TYPE: dynType = DYNAMIC_TYPE_DILITHIUM; break;
            case FALCON_TYPE:    dynType = DYNAMIC_TYPE_FALCON;    break;
            case SPHINCS_TYPE:   dynType = DYNAMIC_TYPE_SPHINCS;   break;
            case XMSS_TYPE:      dynType = DYNAMIC_TYPE_XMSS;      break;
...
#endif
#ifdef HAVE_DILITHIUM
    wcchar BEGIN_DILITHIUM_PRIV    = "-----BEGIN DILITHIUM PRIVATE KEY-----";
    wcchar END_DILITHIUM_PRIV      = "-----END DILITHIUM PRIVATE KEY-----";
#endif
#ifdef HAVE_FALCON
    wcchar BEGIN_FALCON_PRIV       = "-----BEGIN FALCON PRIVATE KEY-----";
    wcchar END_FALCON_PRIV         = "-----END FALCON PRIVATE KEY-----";
#endif
#ifdef HAVE_SPHINCS
    wcchar BEGIN_SPHINCS_PRIV      = "-----BEGIN SPHINCS PRIVATE KEY-----";
    wcchar END_SPHINCS_PRIV        = "-----END SPHINCS PRIVATE KEY-----";
#endif
#ifdef HAVE_XMSS
    wcchar BEGIN_XMSS_PRIV         = "-----BEGIN XMSS PRIVATE KEY-----";
    wcchar END_XMSS_PRIV           = "-----END XMSS PRIVATE KEY-----";
#endif
...
int wc_PemGetHeaderFooter(int type, const char** header, const char** footer)
{
    ...
    #ifdef HAVE_DILITHIUM
        case DILITHIUM_TYPE:
        case DILITHIUM_PRIVATEKEY_TYPE:
            if (header) *header = BEGIN_DILITHIUM_PRIV;
            if (footer) *footer = END_DILITHIUM_PRIV;
            ret = 0;
            break;
    #endif
    #ifdef HAVE_FALCON
        case FALCON_TYPE:
        case FALCON_PRIVATEKEY_TYPE:
            if (header) *header = BEGIN_FALCON_PRIV;
            if (footer) *footer = END_FALCON_PRIV;
            ret = 0;
            break;
    #endif
    #ifdef HAVE_SPHINCS
        case SPHINCS_TYPE:
        case SPHINCS_PRIVATEKEY_TYPE:
            if (header) *header = BEGIN_SPHINCS_PRIV;
            if (footer) *footer = END_SPHINCS_PRIV;
            ret = 0;
            break;
    #endif
    #ifdef HAVE_XMSS
        case XMSS_TYPE:
        case XMSS_PRIVATEKEY_TYPE:
            if (header) *header = BEGIN_XMSS_PRIV;
            if (footer) *footer = END_XMSS_PRIV;
            ret = 0;
            break;
    #endif
    #ifdef HAVE_ED25519
              ...
              DerBuffer** pDer, void* heap, EncryptedInfo* info, int* keyFormat)
{
    ...
    for (;;) {
        ...
        if (
            ...
            {
                header =  BEGIN_DILITHIUM_PRIV;       footer = END_DILITHIUM_PRIV;
            } else
    #endif
    #ifdef HAVE_FALCON
        if (
        ...
        #endif
        #ifdef HAVE_DILITHIUM
            header == BEGIN_DILITHIUM_PRIV ||
        #endif
            header == BEGIN_ENC_PRIV_KEY)
            {
                header =  BEGIN_FALCON_PRIV;     footer = END_FALCON_PRIV;
            } else
    #endif
    #ifdef HAVE_SPHINCS
        if (
        ...
        #endif
        #ifdef HAVE_FALCON
            header == BEGIN_FALCON_PRIV ||
        #endif
            header == BEGIN_ENC_PRIV_KEY)
            {
                header =  BEGIN_SPHINCS_PRIV;     footer = END_SPHINCS_PRIV;
            } else
    #endif
     #ifdef HAVE_XMSS
        if (
        ...
        #endif
        #ifdef HAVE_SPHINCS
            header == BEGIN_SPHINCS_PRIV ||
        #endif
            header == BEGIN_ENC_PRIV_KEY)
            {
                header =  BEGIN_XMSS_PRIV;     footer = END_XMSS_PRIV;
            } else
    #endif
    #if defined(HAVE_ED25519) || defined(HAVE_ED448)
        if (
    ...
    if (type == PRIVATEKEY_TYPE) {
        ...
        #endif
        #ifdef HAVE_DILITHIUM
            if (header == BEGIN_DILITHIUM_PRIV)
                *keyFormat = Dilithiumk;
        #endif
        #ifdef HAVE_FALCON
            if (header == BEGIN_FALCON_PRIV)
                *keyFormat = Falconk;
        #endif
        #ifdef HAVE_SPHINCS
            if (header == BEGIN_SPHINCS_PRIV)
                *keyFormat = Sphincsk;
        #endif
        #ifdef HAVE_XMSS
            if (header == BEGIN_XMSS_PRIV)
                *keyFormat = XMSSk;
        #endif
        #if !defined(NO_DSA)
...
/* Write a public Dilithium key to output */
static int SetDilithiumPublicKey(byte* output, DilithiumKey* key, int with_header)
{
    byte bitString[1 + MAX_LENGTH_SZ + 1];
    int  algoSz;
    int  bitStringSz;
...
#else
    byte algo[MAX_ALGO_SZ];
    byte pub[DILITHIUM_PUB_KEY_SIZE];
#endif

#ifdef WOLFSSL_SMALL_STACK
    pub = (byte*)XMALLOC(DILITHIUM_PUB_KEY_SIZE, NULL, DYNAMIC_TYPE_TMP_BUFFER);
    if (pub == NULL)
        return MEMORY_E;
#endif

    idx = wc_ExportDilithiumPublic(key, pub, &pubSz);
    if (idx != 0) {
#ifdef WOLFSSL_SMALL_STACK
        XFREE(pub, NULL, DYNAMIC_TYPE_TMP_BUFFER);
#endif
...
#endif
        algoSz  = SetAlgoID(Dilithiumk, algo, oidKeyType, 0);
...
int wc_DilithiumPublicKeyToDer(DilithiumKey* key, byte* output, word32 inLen,
                                                                    int withAlg)
{
    word32 infoSz = 0;
    word32 keySz  = 0;
    ...
    if ((ret = wc_ExportDilithiumPublic(key, output, &keySz)) != BUFFER_E) {
        WOLFSSL_MSG("Error in getting Dilithium public key size");
        return ret;
    }
    ...
    return SetDilithiumPublicKey(output, key, withAlg);
}
#endif /* HAVE_DILITHIUM && (WOLFSSL_CERT_GEN || WOLFSSL_KEY_GEN) */

#if defined(HAVE_FALCON) && (defined(WOLFSSL_CERT_GEN) || \
                                                       defined(WOLFSSL_KEY_GEN))

/* Write a public Falcon key to output */
static int SetFalconPublicKey(byte* output, FalconKey* key, int with_header)
{
    byte bitString[1 + MAX_LENGTH_SZ + 1];
    int  algoSz;
    int  bitStringSz;
    int  idx;
    word32 pubSz = FALCON_PUB_KEY_SIZE;
#ifdef WOLFSSL_SMALL_STACK
    byte* algo = NULL;
    byte* pub = NULL;
#else
    byte algo[MAX_ALGO_SZ];
    byte pub[FALCON_PUB_KEY_SIZE];
#endif

#ifdef WOLFSSL_SMALL_STACK
    pub = (byte*)XMALLOC(FALCON_PUB_KEY_SIZE, NULL, DYNAMIC_TYPE_TMP_BUFFER);
    if (pub == NULL)
        return MEMORY_E;
#endif

    idx = wc_ExportFalconPublic(key, pub, &pubSz);
    if (idx != 0) {
#ifdef WOLFSSL_SMALL_STACK
        XFREE(pub, NULL, DYNAMIC_TYPE_TMP_BUFFER);
#endif
...
#endif
        algoSz  = SetAlgoID(Falconk, algo, oidKeyType, 0);
...
int wc_FalconPublicKeyToDer(FalconKey* key, byte* output, word32 inLen,
                                                                    int withAlg)
{
    word32 infoSz = 0;
    word32 keySz  = 0;
    ...
    if ((ret = wc_ExportFalconPublic(key, output, &keySz)) != BUFFER_E) {
        WOLFSSL_MSG("Error in getting Falcon public key size");
        return ret;
    }
    ...
    return SetFalconPublicKey(output, key, withAlg);
}
#endif /* HAVE_FALCON && (WOLFSSL_CERT_GEN || WOLFSSL_KEY_GEN) */

#if defined(HAVE_SPHINCS) && (defined(WOLFSSL_CERT_GEN) || \
                                                       defined(WOLFSSL_KEY_GEN))

/* Write a public Sphincs key to output */
static int SetSphincsPublicKey(byte* output, SphincsKey* key, int with_header)
{
    byte bitString[1 + MAX_LENGTH_SZ + 1];
    int  algoSz;
    int  bitStringSz;
    int  idx;
    word32 pubSz = SPHINCS_PUB_KEY_SIZE;
#ifdef WOLFSSL_SMALL_STACK
    byte* algo = NULL;
    byte* pub = NULL;
#else
    byte algo[MAX_ALGO_SZ];
    byte pub[SPHINCS_PUB_KEY_SIZE];
#endif

#ifdef WOLFSSL_SMALL_STACK
    pub = (byte*)XMALLOC(SPHINCS_PUB_KEY_SIZE, NULL, DYNAMIC_TYPE_TMP_BUFFER);
    if (pub == NULL)
        return MEMORY_E;
#endif

    idx = wc_ExportSphincsPublic(key, pub, &pubSz);
    if (idx != 0) {
#ifdef WOLFSSL_SMALL_STACK
        XFREE(pub, NULL, DYNAMIC_TYPE_TMP_BUFFER);
#endif
...
#endif
        algoSz  = SetAlgoID(Sphincsk, algo, oidKeyType, 0);
...
int wc_SphincsPublicKeyToDer(SphincsKey* key, byte* output, word32 inLen,
                                                                    int withAlg)
{
    word32 infoSz = 0;
    word32 keySz  = 0;
    ...
    if ((ret = wc_ExportSphincsPublic(key, output, &keySz)) != BUFFER_E) {
        WOLFSSL_MSG("Error in getting Sphincs public key size");
        return ret;
    }
    ...
    return SetSphincsPublicKey(output, key, withAlg);
}
#endif /* HAVE_SPHINCS && (WOLFSSL_CERT_GEN || WOLFSSL_KEY_GEN) */

#if defined(HAVE_XMSS) && (defined(WOLFSSL_CERT_GEN) || \
                                                       defined(WOLFSSL_KEY_GEN))

/* Write a public XMSS key to output */
static int SetXmssPublicKey(byte* output, XmssKey* key, int with_header)
{
    byte bitString[1 + MAX_LENGTH_SZ + 1];
    int  algoSz;
    int  bitStringSz;
    int  idx;
    word32 pubSz = XMSS_PUB_KEY_SIZE;
#ifdef WOLFSSL_SMALL_STACK
    byte* algo = NULL;
    byte* pub = NULL;
#else
    byte algo[MAX_ALGO_SZ];
    byte pub[XMSS_PUB_KEY_SIZE];
#endif

#ifdef WOLFSSL_SMALL_STACK
    pub = (byte*)XMALLOC(XMSS_PUB_KEY_SIZE, NULL, DYNAMIC_TYPE_TMP_BUFFER);
    if (pub == NULL)
        return MEMORY_E;
#endif

    idx = wc_ExportXmssPublic(key, pub, &pubSz);
    if (idx != 0) {
#ifdef WOLFSSL_SMALL_STACK
        XFREE(pub, NULL, DYNAMIC_TYPE_TMP_BUFFER);
#endif
...
int wc_XmssPublicKeyToDer(XmssKey* key, byte* output, word32 inLen,
                                                                    int withAlg)
{
    word32 infoSz = 0;
    word32 keySz  = 0;
    ...
    if ((ret = wc_ExportXmssPublic(key, output, &keySz)) != BUFFER_E) {
        WOLFSSL_MSG("Error in getting XMSS public key size");
        return ret;
    }
    ...
    return SetXmssPublicKey(output, key, withAlg);
}
#endif /* HAVE_XMSS && (WOLFSSL_CERT_GEN || WOLFSSL_KEY_GEN) */
...
static int EncodeCert(Cert* cert, DerCert* der, RsaKey* rsaKey, ecc_key* eccKey,
                      ...
                      DilithiumKey* dilithiumKey, FalconKey* falconKey,
                      SphincsKey* sphincsKey, XmssKey* xmssKey)
{
    int ret;
    ...
    if (rsaKey == NULL && eccKey == NULL && ed25519Key == NULL &&
        dilithiumKey == NULL && falconKey == NULL && sphincsKey == NULL &&
        xmssKey == NULL && dsaKey == NULL && ed448Key == NULL && ntruKey == NULL) {
        return PUBLIC_KEY_E;
    }
    ...
    if (cert->keyType == DILITHIUM_KEY) {
        if (dilithiumKey == NULL)
            return PUBLIC_KEY_E;
        der->publicKeySz = SetDilithiumPublicKey(der->publicKey, dilithiumKey, 1);
    }
#endif

#ifdef HAVE_FALCON
    if (cert->keyType == FALCON_KEY) {
        if (falconKey == NULL)
            return PUBLIC_KEY_E;
        der->publicKeySz = SetFalconPublicKey(der->publicKey, falconKey, 1);
    }
#endif

#ifdef HAVE_SPHINCS
    if (cert->keyType == SPHINCS_KEY) {
        if (sphincsKey == NULL)
            return PUBLIC_KEY_E;
        der->publicKeySz = SetSphincsPublicKey(der->publicKey, sphincsKey, 1);
    }
#endif
    ...
    if (cert->keyType == XMSS_KEY) {
        if (xmssKey == NULL)
            return PUBLIC_KEY_E;
        der->publicKeySz = SetXmssPublicKey(der->publicKey, xmssKey, 1);
    }
#endif
...
static int MakeSignature(CertSignCtx* certSignCtx, const byte* buf, int sz,
    ...
    ed25519_key* ed25519Key, ed448_key* ed448Key, DilithiumKey* dilithiumKey,
    FalconKey* falconKey, SphincsKey* sphincsKey, XmssKey* xmssKey, WC_RNG* rng,
    int sigAlgoType, void* heap)
{
    ...
    case CERTSIGN_STATE_DO:
    ...
    #ifdef HAVE_DILITHIUM
        if (!rsaKey && !eccKey && !ed25519Key && !ed448Key && dilithiumKey) {
            word32 outSz = sigSz;
            ret = wc_DilithiumSign (sig, (size_t*)&outSz, certSignCtx->digest,
                                          (size_t)digestSz, dilithiumKey, rng);
            if (ret == 0)
                ret = outSz;
        }
    #endif /* HAVE_DILITHIUM */
        ...
        if (!rsaKey && !eccKey && !ed25519Key && !ed448Key && !dilithiumKey &&
            falconKey) {
            word32 outSz = sigSz;
            ret = wc_FalconSign (sig, (size_t*)&outSz, certSignCtx->digest,
                                          (size_t)digestSz, falconKey, rng);
            if (ret == 0)
                ret = outSz;
        }
    #endif /* HAVE_FALCON */
    ...
    #ifdef HAVE_SPHINCS
        if (!rsaKey && !eccKey && !ed25519Key && !ed448Key && !dilithiumKey &&
            !falconKey && sphincsKey) {
            word32 outSz = sigSz;
            ret = wc_SphincsSign (sig, (long long unsigned int*)&outSz, certSignCtx->digest,
                                          (size_t)digestSz, sphincsKey, rng);
            if (ret == 0)
                ret = outSz;
        }
    #endif /* HAVE_SPHINCS */
    ...
    #ifdef HAVE_XMSS
        if (!rsaKey && !eccKey && !ed25519Key && !ed448Key && !dilithiumKey &&
            !falconKey && !sphincsKey && xmssKey) {
            word32 outSz = sigSz;
            ret = wc_XmssSign (sig, (long long unsigned int*)&outSz, certSignCtx->digest,
                                          (size_t)digestSz, xmssKey);
            if (ret == 0)
                ret = outSz;
        }
    #endif /* HAVE_XMSS */
                       ...
                       SphincsKey* sphincsKey, XmssKey* xmssKey)
{
    ...
    else if (dilithiumKey)
        cert->keyType = DILITHIUM_KEY;
    else if (falconKey)
        cert->keyType = FALCON_KEY;
    else if (sphincsKey)
        cert->keyType = SPHINCS_KEY;
    else if (xmssKey)
        cert->keyType = XMSS_KEY;
    else
        return BAD_FUNC_ARG;
    ...
    ret = EncodeCert(cert, der, rsaKey, eccKey, rng, ntruKey, ntruSz, dsaKey,
            ed25519Key, ed448Key, dilithiumKey, falconKey, sphincsKey, xmssKey);
    if (ret == 0) {
                   ...
                   void* key, WC_RNG* rng)
{
    ...
    DilithiumKey* dilithiumKey = NULL;
    ...
    else if (keyType == DILITHIUM_TYPE)
        dilithiumKey = (DilithiumKey*)key;
    else if (keyType == FALCON_TYPE)
        falconKey = (FalconKey*)key;
    else if (keyType == SPHINCS_TYPE)
        sphincsKey = (SphincsKey*)key;
    else if (keyType == XMSS_TYPE)
        xmssKey = (XmssKey*)key;

    return MakeAnyCert(cert, derBuffer, derSz, rsaKey, eccKey, rng, dsaKey,
                       NULL, 0, ed25519Key, ed448Key, dilithiumKey,
                       falconKey, sphincsKey, xmssKey);
}
/* Make an x509 Certificate v3 RSA or ECC from cert input, write to buffer */
                  ...
                  const byte* ntruKey, word16 keySz, WC_RNG* rng)
{
    return MakeAnyCert(cert, derBuffer, derSz, NULL, NULL, rng, NULL,
            ntruKey, keySz, NULL, NULL, NULL, NULL, NULL, NULL);
}
...
int wc_MakeDilithiumCert(Cert* cert, byte* derBuffer, word32 derSz,
                         DilithiumKey* dilithiumKey, WC_RNG* rng)
{
    return MakeAnyCert(cert, derBuffer, derSz, NULL, NULL, rng, NULL, NULL, 0,
                       NULL, NULL, dilithiumKey, NULL, NULL, NULL);
}
...
int wc_MakeFalconCert(Cert* cert, byte* derBuffer, word32 derSz,
                         FalconKey* falconKey, WC_RNG* rng)
{
    return MakeAnyCert(cert, derBuffer, derSz, NULL, NULL, rng, NULL, NULL, 0,
                       NULL, NULL, NULL, falconKey, NULL, NULL);
}
...
int wc_MakeSphincsCert(Cert* cert, byte* derBuffer, word32 derSz,
                         SphincsKey* sphincsKey, WC_RNG* rng)
{
    return MakeAnyCert(cert, derBuffer, derSz, NULL, NULL, rng, NULL, NULL, 0,
                       NULL, NULL, NULL, NULL, sphincsKey, NULL);
}
...
int wc_MakeXmssCert(Cert* cert, byte* derBuffer, word32 derSz,
                         XmssKey* xmssKey, WC_RNG* rng)
{
    return MakeAnyCert(cert, derBuffer, derSz, NULL, NULL, rng, NULL, NULL, 0,
                       NULL, NULL, NULL, NULL, NULL, xmssKey);
}
                         ...
                         SphincsKey* sphincsKey, XmssKey* xmssKey)
{
    ...
    if (rsaKey == NULL && eccKey == NULL && ed25519Key == NULL &&
        dsaKey == NULL && ed448Key == NULL && dilithiumKey == NULL &&
        falconKey == NULL && sphincsKey == NULL && xmssKey == NULL) {
            return PUBLIC_KEY_E;
    }
                   ...
                   SphincsKey* sphincsKey, XmssKey* xmssKey)
{
    ...
    ret = EncodeCertReq(cert, der, rsaKey, dsaKey, eccKey, ed25519Key, ed448Key,
                        dilithiumKey, falconKey, sphincsKey, xmssKey);
                      ...
                      void* key)
{
    ...
    return MakeCertReq(cert, derBuffer, derSz, rsaKey, dsaKey, eccKey, ed25519Key,
                       ed448Key, dilithiumKey, falconKey, sphincsKey, xmssKey);
}
...
static int SignCert(int requestSz, int sType, byte* buf, word32 buffSz,
                    ...
                    ed448_key* ed448Key, DilithiumKey* dilithiumKey,
                    FalconKey* falconKey, SphincsKey* sphincsKey,
                    XmssKey* xmssKey, WC_RNG* rng)
{
    int sigSz = 0;
    void* heap = NULL;
    ...
    sigSz = MakeSignature(certSignCtx, buf, requestSz, certSignCtx->sig,
        MAX_ENCODED_SIG_SZ, rsaKey, eccKey, ed25519Key, ed448Key, dilithiumKey,
        falconKey, sphincsKey, xmssKey, rng, sType, heap);
#ifdef WOLFSSL_ASYNC_CRYPT
                   ...
                   int keyType, void* key, WC_RNG* rng)
{
    ...
    return SignCert(requestSz, sType, buf, buffSz, rsaKey, eccKey, ed25519Key,
                    ed448Key, dilithiumKey, falconKey, sphincsKey, xmssKey, rng);
}
                                 ...
                                 int kid_type)
{
    ...
    if (cert == NULL ||
        (rsakey == NULL && eckey == NULL && ntruKey == NULL &&
         ed25519Key == NULL && ed448Key == NULL && dilithiumKey == NULL &&
         falconKey == NULL && sphincsKey == NULL && xmssKey == NULL) ||
    ...
    if (dilithiumKey != NULL)
        bufferSz = SetDilithiumPublicKey(buf, dilithiumKey, 0);
#endif
#ifdef HAVE_FALCON
    /* Falcon public key */
    if (falconKey != NULL)
        bufferSz = SetFalconPublicKey(buf, falconKey, 0);
#endif
#ifdef HAVE_SPHINCS
    /* Sphincs public key */
    if (sphincsKey != NULL)
        bufferSz = SetSphincsPublicKey(buf, sphincsKey, 0);
#endif
#ifdef HAVE_XMSS
    /* XMSS public key */
    if (xmssKey != NULL)
        bufferSz = SetXmssPublicKey(buf, xmssKey, 0);
#endif
...
int wc_SetSubjectKeyIdFromPublicKey_ex(Cert *cert, int keyType, void* key)
{
    ...
    return SetKeyIdFromPublicKey(cert, rsaKey, eccKey, NULL, 0, ed25519Key,
                                 ed448Key, dilithiumKey, falconKey, sphincsKey,
                                 xmssKey, SKID_TYPE);
}
...
{
    return SetKeyIdFromPublicKey(cert, rsakey, eckey, NULL, 0, NULL, NULL, NULL,
                                 NULL, NULL, NULL, SKID_TYPE);
}

#ifdef HAVE_DILITHIUM
/* Set SKID from Dilithium public key */
int wc_SetSubjectKeyIdFromDilithiumPublicKey(Cert *cert,
                                             DilithiumKey *dilithiumKey)
{
    return SetKeyIdFromPublicKey(cert, NULL, NULL, NULL, 0, NULL, NULL,
                                 dilithiumKey, NULL, NULL, NULL, SKID_TYPE);
}
#endif

#ifdef HAVE_FALCON
/* Set SKID from Falcon public key */
int wc_SetSubjectKeyIdFromFalconPublicKey(Cert *cert,
                                             FalconKey *falconKey)
{
    return SetKeyIdFromPublicKey(cert, NULL, NULL, NULL, 0, NULL, NULL,
                                 NULL, falconKey, NULL, NULL, SKID_TYPE);
}
#endif

#ifdef HAVE_SPHINCS
/* Set SKID from Sphincs public key */
int wc_SetSubjectKeyIdFromSphincsPublicKey(Cert *cert,
                                             SphincsKey *sphincsKey)
{
    return SetKeyIdFromPublicKey(cert, NULL, NULL, NULL, 0, NULL, NULL,
                                 NULL, NULL, sphincsKey, NULL, SKID_TYPE);
}
#endif

#ifdef HAVE_XMSS
/* Set SKID from XMSS public key */
int wc_SetSubjectKeyIdFromXmssPublicKey(Cert *cert,
                                             XmssKey *xmssKey)
{
    return SetKeyIdFromPublicKey(cert, NULL, NULL, NULL, 0, NULL, NULL,
                                 NULL, NULL, NULL, xmssKey, SKID_TYPE);
}
#endif
...
#ifdef HAVE_DILITHIUM
int wc_DilithiumPrivateKeyDecode(const byte* input, word32* inOutIdx,
                            DilithiumKey* key, word32 inSz)
{
    word32      oid;
    ...
    if (GetSequence(input, inOutIdx, &length, inSz) >= 0) {
        ...
        if (GetMyVersion(input, inOutIdx, &version, inSz) < 0)
            return ASN_PARSE_E;
        if (version != 0) {
            WOLFSSL_MSG("Unrecognized version of Dilithium private key");
            return ASN_PARSE_E;
        }
    ...
    if (endKeyIdx == (int)*inOutIdx) {
        ...
        *inOutIdx += pubSz;
        ...
        ret = wc_ImportDilithiumKeys(priv, privSz, pub, pubSz, key);
    }
    if (ret == 0 && endKeyIdx != (int)*inOutIdx)
        return ASN_PARSE_E;
...
int wc_DilithiumPublicKeyDecode(const byte* input, word32* inOutIdx,
                            DilithiumKey* key, word32 inSz)
{
    int    length;
    int    ret;
    ...
    /* This is the raw point data compressed or uncompressed. */
    if (wc_ImportDilithiumPublic(input + *inOutIdx, inSz - *inOutIdx, key) != 0)
        return ASN_ECC_KEY_E;
...
/* build DER formatted Dilithium key,
 * return length on success, negative on error */
static int wc_BuildDilithiumKeyDer(DilithiumKey* key, byte* output, word32 inLen,
                               int pubOut)
{
    (void)pubOut;
    byte algo[MAX_ALGO_SZ];
    ...
    word32  verSz;
    word32  bitStringSz;
    word32  privSz = DILITHIUM_PRIV_KEY_SIZE;
    int  idx = 0;
    ...
    /* Private key */
    priv = (byte*)XMALLOC(DILITHIUM_PRIV_KEY_SIZE, NULL, DYNAMIC_TYPE_TMP_BUFFER);
    if (priv == NULL)
        return MEMORY_E;

    idx = wc_ExportDilithiumPrivate(key, priv, &privSz);
    if(idx != 0) {
    ...
    algoSz = SetAlgoID(Dilithiumk, algo, oidKeyType, 0);
    verSz  = SetMyVersion(0, ver, FALSE);
    bitStringSz = SetOctetString(DILITHIUM_PRIV_KEY_SIZE, bitString);
    idx  = SetSequence(verSz + algoSz + privSz + bitStringSz, output);

    if (idx + verSz + algoSz + privSz + bitStringSz > inLen)
        return BAD_FUNC_ARG;
...
/* Write a Private ecc key, including public to DER format,
 * length on success else < 0 */
int wc_DilithiumKeyToDer(DilithiumKey* key, byte* output, word32 inLen)
{
    return wc_BuildDilithiumKeyDer(key, output, inLen, 1);
}
...
#ifdef HAVE_FALCON
int wc_FalconPrivateKeyDecode(const byte* input, word32* inOutIdx,
                            FalconKey* key, word32 inSz)
{
    word32      oid;
    int         version, length, endKeyIdx, privSz, pubSz;
    int         ret = 0;
    ...
    if (GetSequence(input, inOutIdx, &length, inSz) >= 0) {
        ...
        if (GetMyVersion(input, inOutIdx, &version, inSz) < 0)
            return ASN_PARSE_E;
        if (version != 0) {
            WOLFSSL_MSG("Unrecognized version of Falcon private key");
            return ASN_PARSE_E;
        }
    ...
    if (endKeyIdx == (int)*inOutIdx) {
        ...
        *inOutIdx += pubSz;
        ...
        ret = wc_ImportFalconKeys(priv, privSz, pub, pubSz, key);
    }
    if (ret == 0 && endKeyIdx != (int)*inOutIdx)
        return ASN_PARSE_E;
...
int wc_FalconPublicKeyDecode(const byte* input, word32* inOutIdx,
                            FalconKey* key, word32 inSz)
{
    int    length;
    int    ret;
    ...
    /* This is the raw point data compressed or uncompressed. */
    if (wc_ImportFalconPublic(input + *inOutIdx, inSz - *inOutIdx, key) != 0)
        return ASN_ECC_KEY_E;
...
/* build DER formatted Falcon key,
 * return length on success, negative on error */
static int wc_BuildFalconKeyDer(FalconKey* key, byte* output, word32 inLen,
                               int pubOut)
{
    (void)pubOut;
    byte algo[MAX_ALGO_SZ];
    ...
    word32  verSz;
    word32  bitStringSz;
    word32  privSz = FALCON_PRIV_KEY_SIZE;
    int  idx = 0;
    ...
    /* Private key */
    priv = (byte*)XMALLOC(FALCON_PRIV_KEY_SIZE, NULL, DYNAMIC_TYPE_TMP_BUFFER);
    if (priv == NULL)
        return MEMORY_E;

    idx = wc_ExportFalconPrivate(key, priv, &privSz);
    if(idx != 0) {
        XFREE(priv, NULL, DYNAMIC_TYPE_TMP_BUFFER);
        return idx;
    }
    ...
    algoSz = SetAlgoID(Falconk, algo, oidKeyType, 0);
    verSz  = SetMyVersion(0, ver, FALSE);
    bitStringSz = SetOctetString(FALCON_PRIV_KEY_SIZE, bitString);
    idx  = SetSequence(verSz + algoSz + privSz + bitStringSz, output);
...
/* Write a Private ecc key, including public to DER format,
 * length on success else < 0 */
int wc_FalconKeyToDer(FalconKey* key, byte* output, word32 inLen)
{
    return wc_BuildFalconKeyDer(key, output, inLen, 1);
}
...
#ifdef HAVE_SPHINCS
int wc_SphincsPrivateKeyDecode(const byte* input, word32* inOutIdx,
                            SphincsKey* key, word32 inSz)
{
    word32      oid;
    int         version, length, endKeyIdx, privSz, pubSz;
    int         ret = 0;
    ...
    if (GetSequence(input, inOutIdx, &length, inSz) >= 0) {
        ...
        if (GetMyVersion(input, inOutIdx, &version, inSz) < 0)
            return ASN_PARSE_E;
        if (version != 0) {
            WOLFSSL_MSG("Unrecognized version of Sphincs private key");
            return ASN_PARSE_E;
        }
    ...
    if (endKeyIdx == (int)*inOutIdx) {
        ...
        *inOutIdx += pubSz;
        ...
        ret = wc_ImportSphincsKeys(priv, privSz, pub, pubSz, key);
    }
    if (ret == 0 && endKeyIdx != (int)*inOutIdx)
        return ASN_PARSE_E;
...
int wc_SphincsPublicKeyDecode(const byte* input, word32* inOutIdx,
                            SphincsKey* key, word32 inSz)
{
    int    length;
    int    ret;
    ...
    /* This is the raw point data compressed or uncompressed. */
    if (wc_ImportSphincsPublic(input + *inOutIdx, inSz - *inOutIdx, key) != 0)
        return ASN_ECC_KEY_E;
...
/* build DER formatted Sphincs key,
 * return length on success, negative on error */
static int wc_BuildSphincsKeyDer(SphincsKey* key, byte* output, word32 inLen,
                               int pubOut)
{
    (void)pubOut;
    byte algo[MAX_ALGO_SZ];
    ...
    word32  verSz;
    word32  bitStringSz;
    word32  privSz = SPHINCS_PRIV_KEY_SIZE;
    int  idx = 0;
    ...
    /* Private key */
    priv = (byte*)XMALLOC(SPHINCS_PRIV_KEY_SIZE, NULL, DYNAMIC_TYPE_TMP_BUFFER);
    if (priv == NULL)
        return MEMORY_E;

    idx = wc_ExportSphincsPrivate(key, priv, &privSz);
    if(idx != 0) {
        XFREE(priv, NULL, DYNAMIC_TYPE_TMP_BUFFER);
        return idx;
    }
    ...
    algoSz = SetAlgoID(Sphincsk, algo, oidKeyType, 0);
    verSz  = SetMyVersion(0, ver, FALSE);
    bitStringSz = SetOctetString(SPHINCS_PRIV_KEY_SIZE, bitString);
    idx  = SetSequence(verSz + algoSz + privSz + bitStringSz, output);
...
/* Write a Private ecc key, including public to DER format,
 * length on success else < 0 */
int wc_SphincsKeyToDer(SphincsKey* key, byte* output, word32 inLen)
{
    return wc_BuildSphincsKeyDer(key, output, inLen, 1);
}
...
#ifdef HAVE_XMSS
int wc_XmssPrivateKeyDecode(const byte* input, word32* inOutIdx,
                            XmssKey* key, word32 inSz)
{
    word32      oid;
    int         version, length, endKeyIdx, privSz, pubSz;
    int         ret = 0;
    ...
    if (GetSequence(input, inOutIdx, &length, inSz) >= 0) {
        ...
        if (GetMyVersion(input, inOutIdx, &version, inSz) < 0)
            return ASN_PARSE_E;
        if (version != 0) {
            WOLFSSL_MSG("Unrecognized version of XMSS private key");
            return ASN_PARSE_E;
        }
    ...
    if (endKeyIdx == (int)*inOutIdx) {
        ...
        *inOutIdx += pubSz;
        ...
        ret = wc_ImportXmssKeys(priv, privSz, pub, pubSz, key);
    }
    if (ret == 0 && endKeyIdx != (int)*inOutIdx)
        return ASN_PARSE_E;
                           ...
                           XmssKey* key, word32 inSz)
{
    ...
    /* This is the raw point data compressed or uncompressed. */
    if (wc_ImportXmssPublic(input + *inOutIdx, inSz - *inOutIdx, key) != 0)
        return ASN_ECC_KEY_E;
...
/* build DER formatted XMSS key,
 * return length on success, negative on error */
static int wc_BuildXmssKeyDer(XmssKey* key, byte* output, word32 inLen,
                               int pubOut)
{
    (void)pubOut;
    byte algo[MAX_ALGO_SZ];
    ...
    word32  verSz;
    word32  bitStringSz;
    word32  privSz = XMSS_PRIV_KEY_SIZE;
    int  idx = 0;
    ...
    /* Private key */
    priv = (byte*)XMALLOC(XMSS_PRIV_KEY_SIZE, NULL, DYNAMIC_TYPE_TMP_BUFFER);
    if (priv == NULL)
        return MEMORY_E;

    idx = wc_ExportXmssPrivate(key, priv, &privSz);
    if(idx != 0) {
        XFREE(priv, NULL, DYNAMIC_TYPE_TMP_BUFFER);
        return idx;
    }
    ...
    algoSz = SetAlgoID(XMSSk, algo, oidKeyType, 0);
    verSz  = SetMyVersion(0, ver, FALSE);
    bitStringSz = SetOctetString(XMSS_PRIV_KEY_SIZE, bitString);
    idx  = SetSequence(verSz + algoSz + privSz + bitStringSz, output);
...
/* Write a Private ecc key, including public to DER format,
 * length on success else < 0 */
int wc_XmssKeyToDer(XmssKey* key, byte* output, word32 inLen)
{
    return wc_BuildXmssKeyDer(key, output, inLen, 1);
}
